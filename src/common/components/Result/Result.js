...
export const Result = ({
  ...
  const currency = val => {
    ...
    return (
      <>
        <span className={styles[`result__price--dollars`]}>${currency[0]}</span>
        <span className={styles[`result__price--sr`]}>.</span>
        <span className={styles[`result__price--cents`]}>{currency[1]}</span>
      </>
    );
  };
  ...
  return (
    ...
    >
      <div className={styles[`result__img`]} style={imgStyle}></div>
      ...
      <p className={styles.result__price}>
        <span className={styles[`result__price--price`]}>
          {currency(price)}
        </span>
      ...
      <form action="post">
        ...
        <button>
          +<span className="sr">Add to List</span>
        </button>
      </form>
    </li>
  );
